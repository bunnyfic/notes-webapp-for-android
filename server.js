...
const db = mysql.createPool({
    ...
    connectionLimit: 10,
    queueLimit: 0,
    // Aiven's free MySQL requires SSL (ssl-mode=REQUIRED in the connection URI).
    // If you set DB_CA_CERT (paste the contents of the CA certificate Aiven
    // lets you download from the console) the connection will be verified
    // properly. Without it, we still encrypt the connection but skip
    // certificate verification, which is fine to get started but not
